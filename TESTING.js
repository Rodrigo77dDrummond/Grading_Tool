...
function Comment(){
  comment =       messages[button1.value()] + messages[button2.value()] + messages[button3.value()] + messages[button4.value()] + messages[button5.value()] + messages[button6.value()] + messages[button7.value()] + messages[button8.value()] + messages[button9.value()] + messages[button10.value()] + messages[button11.value()] + messages[button12.value()] + messages[button13.value()] + messages[button14.value()] + messages[button15.value()] + messages[button16.value()] + messages[button17.value()] + messages[button18.value()] + messages[button19.value()] + messages[button20.value()] + messages[button21.value()] + messages[button22.value()] + messages[button23.value()] + messages[button24.value()] + messages[button25.value()] + messages[button26.value()] + messages[button27.value()]
}
